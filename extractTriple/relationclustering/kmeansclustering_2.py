...
from relfeaturegen_2 import RelFeatureGen
...
if __name__=='__main__':
    #dir_path = '../data/food/relation_result/data_split_0/'
    dir_path = '../data/nyt/relation_result/data_split_2/'
    n_clusters = 100
    #for the yelp food
    #n_components=1500 #0.7
    #for nyt
    n_components=3000
    relf = RelFeatureGen()
    ...
    nbrs = NearestNeighbors(n_neighbors=200, algorithm='kd_tree').fit(X_latent_neigh)
    print 'end to get nearest neighbors'
    for key in set_miss_rel:
        print 'set_miss_rel',key
        distances, indices = nbrs.kneighbors(X_latent_neigh[key])
        neighbors = indices
